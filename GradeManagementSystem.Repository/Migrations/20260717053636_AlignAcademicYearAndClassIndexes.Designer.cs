...
namespace GradeManagementSystem.Repository.Migrations
{
    ...
    [Migration("20260717053636_AlignAcademicYearAndClassIndexes")]
    partial class AlignAcademicYearAndClassIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GradeManagementSystem.Core.Entities.Domain.Class", b =>
                {
                    ...
                    b.HasIndex("AcademicYearID", "DepartmentID", "ClassName")
                        .IsUnique()
                        .HasFilter("[AcademicYearID] IS NOT NULL AND [DepartmentID] IS NOT NULL");
